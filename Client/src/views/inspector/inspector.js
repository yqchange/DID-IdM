...
/*
  ...
  createDid(){
    ...
    const ethrDid = new EthrDID({address: '0x0d9F585DC2E20BC9ef0248655625166eEF8FcA55',  //account from my metamask wallet
                                privateKey: '423bb2328fe75f2a39a559651db80c0cc67c7177e45a60718616c07e85218df1', 
                                provider})
    ...
    return (
            <div className="App">
              <div className="App-header">
                ...
                <h2 className="headerFont">***Inspector Interface***</h2>
              </div>
