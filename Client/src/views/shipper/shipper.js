...
/*
  ...
  bidOrder = (orderID, price) => {
    this.state.logistics.methods.bidOrderByShipper(orderID, price).send({ from: this.state.account });
  };
  ...
  createDid(){
    ...
    const ethrDid = new EthrDID({address: '0xDE7A5cf1867e989F01fE51fd7c74D057ba7f7954',  //account from my metamask wallet
                                privateKey: 'ecdc7b2f1044362d2b4e062de5c987bd1cb319426fb91064f414a6a057f8466a', 
                                provider})
