...
function get(url) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, cross_fetch_1.default(url, { mode: 'cors' })];
                case 1:
                    res = _a.sent();
                    if (res.status >= 400) {
...
function getResolver() {
    function resolve(did, parsed) {
        return __awaiter(this, void 0, void 0, function () {
            var path, id, url, data, error_1, docIdMatchesDid, docHasPublicKey;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        path = parsed.id + DOC_PATH;
                        id = parsed.id.split(':');
                        if (id.length > 1)
                            path = id.join('/') + '/did.json';
                        url = "https://" + path;
                        data = null;
                        _a.label = 1;
                    case 1:
                    ...
                    case 3:
                        error_1 = _a.sent();
                        throw new Error("DID must resolve to a valid https URL containing a JSON document: " + error_1.message);
                    case 4:
