...
import { JwtCredentialPayload, VerifiedPresentation, CredentialPayload } from 'did-jwt-vc/lib/types';
declare enum Types {
...
declare class Credentials {
    ...
    issueVerifiableCredential(vcPayload: JwtCredentialPayload | CredentialPayload): Promise<string>;
    verifyPresentation(vpJwt: string): Promise<VerifiedPresentation>;
    /**
